...
// Valores para el tama�o de la ventana de despliegue
GLsizei winWidth=600, winHeight=600;

// Fija el tama�o de las coordenadas del mundo de la ventana de recorte
...
main(int argc, char **argv)
{
	...
	glutCreateWindow("Ejemplo de curvas de Bezier");
	init();
